...
export default function ConfigPanel() {
  const [cfg, setCfg] = useState<ConfigUpdate>(defaultConfig);
  ...
  return (
    <div className="card">
      <div className="card-header">
        ...
        <span style={{ fontSize: 10, color: 'var(--text-muted)' }}>Changes apply within 30s</span>
      </div>

      <div className="card-body" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 }}>
