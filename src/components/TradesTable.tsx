...
interface Props { trades: Trade[] | undefined; isLoading: boolean; }

const EXIT_LABELS: Record<string, { label: string; cls: string }> = {
  TP_HIT:      { label: 'TP Hit',     cls: 'badge-green'  },
  SL_HIT:      { label: 'SL Hit',     cls: 'badge-red'    },
  SIGNAL_EXIT: { label: 'Signal',     cls: 'badge-blue'   },
  MANUAL:      { label: 'Manual',     cls: 'badge-amber'  },
};
