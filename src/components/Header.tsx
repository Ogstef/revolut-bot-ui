...
interface Props { status: BotStatus | undefined; isLoading: boolean; }

export default function Header({ status, isLoading }: Props) {
  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
        ...
        {status?.reportedAt && (
          <Metric label="Last update" value={
