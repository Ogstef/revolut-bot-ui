...
export default function StrategyNav({ activeTab, onTabChange, strategies }: Props) {
  ...
  return (
    <aside style={{
      ...
      <SideItem label="Today"     active={activeTab === 'today'}      onClick={() => onTabChange('today')} accent />
      ...
      <SideItem label="Charts"         active={activeTab === 'charts'}         onClick={() => onTabChange('charts')}         accent />
      <SideItem label="Backtest"       active={activeTab === 'backtest'}       onClick={() => onTabChange('backtest')}       accent />
